            ...
            {products && products.map((v,index)=>{
              return(
                        ...
                        <div className="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                            <img className="img-fluid w-100" src={v.image} alt />
                        </div>
                        <div className="card-body border-left border-right text-center p-0 pt-4 pb-3">
                           <NavLink to={"/productSingle/"+v.id} >
                           <h6 className="text-truncate mb-3">{v.title}</h6>
                           </NavLink>
                            <div className="d-flex justify-content-center">
                            <h6>{v.price}</h6><h6 className="text-muted ml-2"><del>{v.oprice}</del></h6>
                            </div>
                        </div>
